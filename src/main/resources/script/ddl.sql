...
(
    resident_serial_number       int(11)      AUTO_INCREMENT not null,
...
(
    ...
    CONSTRAINT fk_birthDeath_resident FOREIGN KEY (resident_serial_number) REFERENCES resident (resident_serial_number),
    CONSTRAINT fk_report_resident FOREIGN KEY (report_resident_serial_number) REFERENCES resident (resident_serial_number)
);
...
(
    ...
    CONSTRAINT fk_base_relationship_resident FOREIGN KEY (base_resident_serial_number) REFERENCES resident(resident_serial_number),
    CONSTRAINT fk_family_relationship_resident FOREIGN KEY (family_resident_serial_number) REFERENCES resident(resident_serial_number)
);
...
(
    ...
    CONSTRAINT fk_household_resident FOREIGN KEY (household_resident_serial_number) REFERENCES  resident(resident_serial_number)
);
...
(
    ...
    CONSTRAINT fk_movement_address_household FOREIGN KEY (household_serial_number) REFERENCES household(household_serial_number)
);
...
(
    ...
    CONSTRAINT fk_composition_resident_household FOREIGN KEY (household_serial_number) REFERENCES household(household_serial_number),
    CONSTRAINT fk_composition_resident_resident FOREIGN KEY (resident_serial_number) REFERENCES resident(resident_serial_number)
...
(
    ...
    CONSTRAINT fk_certificate_resident FOREIGN KEY (resident_serial_number) REFERENCES resident(resident_serial_number)
);
